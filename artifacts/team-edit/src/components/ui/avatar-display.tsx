...
export function StackedAvatars({ people, size = 28, max = 3, className }: StackedAvatarsProps) {
  ...
  return (
    <div className={cn("flex items-center", className)} style={{ gap: 0 }}>
      ...
      {overflow > 0 && (
        <div
          className="rounded-full flex items-center justify-center font-bold shrink-0 ring-[1.5px] ring-gray-200 shadow-sm select-none bg-[hsl(var(--muted))] text-[hsl(var(--muted-foreground))]"
